        ...
        >
            ...
            <ul className="flex space-x-10 text-center">
                ...
                <li>
                    <Link
                        to="/search-public"
                        className={`text-lg font-semibold ${(location.pathname === '/Search_PublicUser' || location.pathname === '/SearchByFilter_PublicUser' || location.pathname === '/AfterFilter_PublicUser' || location.pathname === '/Display_PublicUser')  ? 'text-[#016a70]' : 'text-[#393E46]'} hover:text-[#004f57]`}
                    >
                        Search
                    </Link>
                </li>
