...
const AfterFilter_GeneralUser = () => {
    const companies = [ 
        ...
        "BAN HOCK HUAT TRADING AS BAN HOCK HUAT TRANSPORT",
        "IDK HAHAHHA COMPANY TESTINGHOHO",
        "IKR HAHAHHA COMPANY TESTINGHOHO"
    ...
    return (
        <div className="w-full h-full">
            ...
            <div className="flex justify-end mt-6 pr-12">
                <Link 
                    to="/SearchByFilter_GeneralUser" // Adjust this link based on where "back" should go
...
export default AfterFilter_GeneralUser;